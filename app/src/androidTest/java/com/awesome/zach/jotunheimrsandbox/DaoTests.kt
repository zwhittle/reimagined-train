...
class DaoTests {
    ...
    private lateinit var taskTagAssignmentDao: TaskTagDao
...
//             val updatedCount = taskTagDao.updateTaskTagAssignment(taskTagAssignment)
//             assertThat(updatedCount, equalTo(1))
//         } else {
...
//
//         val taskTagAssignments = taskTagDao.getAllTaskTagAssignments()
//         taskTagAssignments.forEach { taskTagAssignment ->
//             taskTagAssignment.taskId = taskDao.getAllTasks()[1].id
//             taskTagAssignment.tagId = tagDao.getAllTags()[3].id
//         }
//
//         val updatedCount = taskTagDao.bulkUpdateTaskTagAssignments(taskTagAssignments)
...
//         val taskTagAssignment = writeTaskTagAssignment()[KEY_RETURNED]
//         if (taskTagAssignment != null) {
//             val deletedCount = taskTagDao.deleteTaskTagAssignment(taskTagAssignment)
//             assertThat(deletedCount, equalTo(1))
//         } else {
//             throw Exception("taskTagAssignment is null")
//         }
...
//         bulkWriteTaskTagAssignments()
//         val taskTagAssignments = taskTagDao.getAllTaskTagAssignments()
//         val deletedCount = taskTagDao.bulkDeleteTaskTagAssignments(taskTagAssignments)
//
...
//         bulkWriteTaskTagAssignments()
//         val taskTagAssignments = taskTagDao.getAllTaskTagAssignments()
//         val deletedCount = taskTagDao.deleteAllTaskTagAssignments()
//
//         val countsMatch = deletedCount == taskTagAssignments.size
//         val noMoreTaskTagAssignments = taskTagDao.getAllTaskTagAssignments().isEmpty()
//
...
//         val returnedId = taskTagDao.insertTaskTagAssignment(taskTagAssignmentToInsert)
//         val returnedTaskTagAssignment = taskTagDao.getTaskTagAssignmentById(returnedId)
//         taskTagAssignmentToInsert.id = returnedId
//
...
//         val returnedIds = taskTagDao.bulkInsertTaskTagAssignments(taskTagAssignmentsToInsert)
//         dbSeeder.taskTagAssignments = ArrayList(taskTagDao.getAllTaskTagAssignments())
//
//         val compareValues = mutableMapOf<String, Int>()
