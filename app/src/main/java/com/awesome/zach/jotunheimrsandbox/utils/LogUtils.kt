...
import com.awesome.zach.jotunheimrsandbox.BuildConfig

object LogUtils {
    private const val LOG_TAG = "JH"
    ...
    fun log(tag: String, data: String) {
        ...
        when {
            ...
            data.startsWith("D::") -> Log.d("$LOG_TAG.$tag", String.format("%s#%s:%s", from, lineNumber, data.substring(3)))
